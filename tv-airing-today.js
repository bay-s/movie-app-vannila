  ...
  providerCountry()
    ...
    async function airToday(){
      const airTodayres = await fetch(
        `https://api.themoviedb.org/3/tv/airing_today?api_key=0ccbee0a69447c2b1bd0090bf76b0358`
      )
      const tv = await airTodayres.json()
      removeLoading()
  ...
  TVCard(isi) 
    ...
    async function paginationPopular(pages) {
      const pageRes = await fetch(
        `https://api.themoviedb.org/3/tv/airing_today?api_key=0ccbee0a69447c2b1bd0090bf76b0358&page=${pages}`
      )
